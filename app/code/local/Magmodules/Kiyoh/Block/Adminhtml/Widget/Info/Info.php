...
class Magmodules_Kiyoh_Block_Adminhtml_Widget_Info_Info extends Mage_Adminhtml_Block_Abstract
    implements Varien_Data_Form_Element_Renderer_Interface
{
    ...
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $moduleVersion = Mage::getConfig()->getNode()->modules->Magmodules_Kiyoh->version;
        $logoLink = '//www.magmodules.eu/logo/kiyoh/' . $moduleVersion . '/' . $magentoVersion . '/logo.png';
            ...
            <table width="500px" border="0">
			    <tr>
					...
					<tr>
						...
						<td>
						  <strong>
						    <a href="http://www.magmodules.eu/help/kiyoh" target="_blank">Online manual</a>
						  </strong>
						</td>
					</tr>
				</table>
